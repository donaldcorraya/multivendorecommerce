                ...
                foreach($colors as $color){
                    ...
                    if (empty(array_filter($attributes_item_arr))){
                        ...
                        <tr>
                            ...
                            <td><input type="text" name="variant_price" value="0" class="form-control"></td>
                            <td>{{ strtolower((isset($color->name)? $color->name : '')) }}</td>
                            <td><input type="text" name="variant_qty" value="0" class="form-control"></td>
                            <td><input type="file" name="variant_img" class="form-control"></td>
                        </tr>

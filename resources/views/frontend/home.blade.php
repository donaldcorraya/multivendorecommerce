    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-3 col-md-4 text-center pt-sm-30">
                <div class="li-banner">
                    <a href="#">
                        <img src="{{ asset('assets/frontend/images/banner/3_1.jpg') }}" alt="">
                    </a>
                </div>
                <div class="li-banner mt-15 mt-sm-30 mt-xs-25 mb-xs-5">
                    <a href="#">
                        <img src="{{ asset('assets/frontend/images/banner/3_2.jpg') }}" alt="">
                    </a>
                </div>
            </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-4 col-md-4 text-center">
                <div class="single-banner pb-xs-30">
                    <a href="#">
                        <img src="{{ asset('assets/frontend/images/banner/1_3.jpg') }}" alt="Li's Static Banner">
                    </a>
                </div>
            </div>
            ...
            <div class="col-lg-4 col-md-4 text-center">
                <div class="single-banner pb-xs-30">
                    <a href="#">
                        <img src="{{ asset('assets/frontend/images/banner/1_4.jpg') }}" alt="Li's Static Banner">
                    </a>
                </div>
            </div>
            <!-- Single Banner Area End Here -->
            ...
            <div class="col-lg-4 col-md-4 text-center">
                <div class="single-banner">
                    <a href="#">
                        <img src="{{ asset('assets/frontend/images/banner/1_5.jpg') }}" alt="Li's Static Banner">
                    </a>
                </div>
            </div>
            <!-- Single Banner Area End Here -->
                    ...
                    <div class="special-product-active owl-carousel">
                            ...
                            <div class="single-product-wrap">
                                <div class="product-image">
                                    <a href="single-product.html">
                                        <img src="{{ asset('assets/frontend/images/product/large-size/1.jpg') }}" alt="Li's Product Image">
                                    </a>
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="single-product-wrap">
                                <div class="product-image">
                                    <a href="single-product.html">
                                        <img src="{{ asset('assets/frontend/images/product/large-size/2.jpg') }}" alt="Li's Product Image">
                                    </a>
                                    <span class="sticker">New</span>
                                </div>
                                <div class="product_desc">
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="single-product-wrap">
                                <div class="product-image">
                                    <a href="single-product.html">
                                        <img src="{{ asset('assets/frontend/images/product/large-size/5.jpg') }}" alt="Li's Product Image">
                                    </a>
                                    <span class="sticker">New</span>
                                </div>
                                <div class="product_desc">
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="single-product-wrap">
                                <div class="product-image">
                                    <a href="single-product.html">
                                        <img src="{{ asset('assets/frontend/images/product/large-size/8.jpg') }}" alt="Li's Product Image">
                                    </a>
                                    <span class="sticker">New</span>
                                </div>
                                <div class="product_desc">
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="single-product-wrap">
                                <div class="product-image">
                                    <a href="single-product.html">
                                        <img src="{{ asset('assets/frontend/images/product/large-size/7.jpg') }}" alt="Li's Product Image">
                                    </a>
                                    <span class="sticker">New</span>
                                </div>
                                <div class="product_desc">
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="single-product-wrap">
                                <div class="product-image">
                                    <a href="single-product.html">
                                        <img src="{{ asset('assets/frontend/images/product/large-size/4.jpg') }}" alt="Li's Product Image">
                                    </a>
                                    <span class="sticker">New</span>
                                </div>
                                <div class="product_desc">
        ...
        <div class="row">
            ...
            <div class="col-lg-3 text-center">
                <div class="single-banner featured-banner">
                    <a href="#">
                        <img src="{{ asset('assets/frontend/images/banner/featured-banner.jpg') }}" alt="Li's Featured Banner">
                    </a>
                </div>
            </div>
                                ...
                                <div class="featured-pro-wrapper mb-30 mb-sm-25">
                                    <div class="product-img">
                                        <a href="product-details.html">
                                            <img alt="" src="{{ asset('assets/frontend/images/featured-product/1.jpg') }}">
                                        </a>
                                    </div>
                    ...
                    <div class="product-active owl-carousel">
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="single-product-wrap">
                                <div class="product-image">
                                    <a href="single-product.html">
                                        <img src="{{ asset('assets/frontend/images/product/large-size/3.jpg') }}" alt="Li's Product Image">
                                    </a>
                                    <span class="sticker">New</span>
                                </div>
                                <div class="product_desc">
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="single-product-wrap">
                                <div class="product-image">
                                    <a href="single-product.html">
                                        <img src="{{ asset('assets/frontend/images/product/large-size/6.jpg') }}" alt="Li's Product Image">
                                    </a>
                                    <span class="sticker">New</span>
                                </div>
                                <div class="product_desc">
                    ...
                    <div class="product-active owl-carousel">
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="single-product-wrap">
                                <div class="product-image">
                                    <a href="single-product.html">
                                        <img src="{{ asset('assets/frontend/images/product/large-size/9.jpg') }}" alt="Li's Product Image">
                                    </a>
                                    <span class="sticker">New</span>
                                </div>
                                <div class="product_desc">
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="single-product-wrap">
                                <div class="product-image">
                                    <a href="single-product.html">
                                        <img src="{{ asset('assets/frontend/images/product/large-size/11.jpg') }}" alt="Li's Product Image">
                                    </a>
                                    <span class="sticker">New</span>
                                </div>
                                <div class="product_desc">
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-6 col-md-6">
                <div class="single-banner pb-xs-30">
                    <a href="#">
                        <img src="{{ asset('assets/frontend/images/banner/2_3.jpg') }}" alt="Li's Static Banner">
                    </a>
                </div>
            </div>
            <!-- Single Banner Area End Here -->
            ...
            <div class="col-lg-6 col-md-6">
                <div class="single-banner">
                    <a href="#">
                        <img src="{{ asset('assets/frontend/images/banner/2_4.jpg') }}" alt="Li's Static Banner">
                    </a>
                </div>
            </div>
            <!-- Single Banner Area End Here -->
                            ...
                            <div class="product-active owl-carousel">
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <div class="single-product-wrap">
                                        <div class="product-image">
                                            <a href="single-product.html">
                                                <img src="{{ asset('assets/frontend/images/product/large-size/10.jpg') }}" alt="Li's Product Image">
                                            </a>
                                            <span class="sticker">New</span>
                                        </div>
                                        <div class="product_desc">
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <div class="single-product-wrap">
                                        <div class="product-image">
                                            <a href="single-product.html">
                                                <img src="{{ asset('assets/frontend/images/product/large-size/12.jpg') }}" alt="Li's Product Image">
                                            </a>
                                            <span class="sticker">New</span>
                                        </div>
                                        <div class="product_desc">
